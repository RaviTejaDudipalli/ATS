...
const values = [
  ...
  {
    icon: Globe,
    title: 'Built by a fed up candidate',
    description:
        ...
        <FadeIn>
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="muted mx-auto mt-5 max-w-2xl text-lg">
              This project is started as a personal project after one too many "thank you for applying" form
      ...
      <section className="container-page pb-24">
        <FadeIn>
          <div className="card grid gap-8 p-10 sm:grid-cols-3">
            {[
              { k: '2,400+', d: 'roles posted' },
              { k: '0', d: 'companies hiring with us' },
